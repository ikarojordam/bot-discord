...
// Incremento de vendas usando apenas operações básicas do Supabase
async function incrementUserSales(userId, guildId) {
  ...
  // Atualiza ou insere com o novo valor
...
async function addRoleToThread(thread, roleId) {
  ...
  // Adiciona os membros em paralelo, mas sem travar se um falhar
...
client.on('interactionCreate', async interaction => {
  ...
  if (interaction.isButton()) {
    // Botões que abrem modal DEVEM ser tratados antes do deferUpdate
    ...
    // Para os demais botões, usamos deferUpdate
    ...
    if (interaction.customId === 'btn_verificado' || interaction.customId === 'btn_recusado') {
      ...
      // Extração mais segura do ID do vendedor
