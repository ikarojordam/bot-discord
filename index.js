...
// ========== CRIAÇÃO DE SERVIDOR (simplificada) ==========
...
async function setupServer(guild, type) {
  // Apagar canais e cargos existentes
...
client.on('interactionCreate', async interaction => {
  ...
  if (interaction.isChatInputCommand()) {
    ...
    // Adicione aqui os handlers dos demais comandos (sorteio, premium, moderação, etc.)
    // Para manter a resposta curta, eles podem ser copiados das versões anteriores.
  }
